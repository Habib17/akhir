                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="{{ URL::asset('user/') }}" >Cabang</a></li>
                                <li><a href="{{ URL::asset('user/') }}" >Cara Pesan</a></li>
                                <li class="dropdown"><a href="#">Akun<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.html">Setting</a></li>
                                        <li><a href="{{ URL::asset('user/detail') }}">Keluar</a></li> 
                                    </ul>
                                </li> 
                            </ul>
                        </div>
