                    ...
                    <tbody>
                        <tr>
                            <td class="cart_product">
                                <a href=""><img src="{{ URL::asset('assets/images/cart/one.png') }}" alt=""></a>
                            </td>
                        ...
                        <tr>
                            <td class="cart_product">
                                <a href=""><img src="{{ URL::asset('assets/images/cart/two.png') }}" alt=""></a>
                            </td>
                            <td class="cart_description">
                                <h4><a href="">Colorblock Scuba</a></h4>
                                <p>Web ID: 1089772</p>
                        ...
                        <tr>
                            <td class="cart_product">
                                <a href=""><img src="{{ URL::asset('assets/images/cart/three.png') }}" alt=""></a>
                            </td>
                            <td class="cart_description">
                                <h4><a href="">Colorblock Scuba</a></h4>
                                <p>Web ID: 1089772</p>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{ URL::asset('user/checkout') }}" class="active"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="{{ URL::asset('user/checkout') }}"  class="active">Checkout</a></li> 
