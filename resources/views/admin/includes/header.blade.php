<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>A</b>GC</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Admin</b>GoldiA</span>
    </a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ URL::asset('assets/admin/dist/img/user4-128x128.jpg') }}"
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{{ URL::asset('assets//user2-160x160.jpg') }}"
                                 class="img-circle" alt="User Image">
