...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/ionslider/ion.rangeSlider.css') }}">
    <!-- ion slider Nice -->
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/ionslider/ion.rangeSlider.skinNice.css') }}">

    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/bootstrap-slider/slider.css') }}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/colorpicker/bootstrap-colorpicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/fullcalendar/fullcalendar.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('assets/admin/plugins/fullcalendar/fullcalendar.print.css') }}" media="print">
    <![endif]-->
    <style>
        .example-modal .modal {
            position: relative;
...
<!-- AdminLTE for demo purposes -->
<script src="{{ URL::asset('assets/admin/dist/js/demo.js') }}"></script>
<script src="{{ URL::asset('assets/admin/plugins/ionslider/ion.rangeSlider.min.js') }}"></script>
<!-- Bootstrap slider -->
<script src="{{ URL::asset('assets/admin/plugins/bootstrap-slider/bootstrap-slider.js') }}"></script>
