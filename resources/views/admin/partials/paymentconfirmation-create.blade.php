...
@endif
        ...
        <div class="col-sm-10">
                <input class="form-control" name="bank"  type="text" placeholder="Bank">
        </div>
        </div>
        <div class="form-group">
            <label  class="col-sm-2 control-label">Nominal</label>
        <div class="col-sm-10">
            <input class="form-control" name="nominal"  type="text" placeholder="Nominal">
        </div>
        </div>
        <div class="form-group">
            <label  class="col-sm-2 control-label">Send At</label>
        <div class="col-sm-10">
            <input class="form-control" name="send_at"  type="text" placeholder="Send At">
        </div>
        </div>
        <div class="form-group">
        ...
        <div class="col-sm-10">
                <input class="form-control" name="bank_account"  type="text" placeholder="Bank Account">
